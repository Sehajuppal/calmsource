// Mirror of web src/lib/episodes.ts.
...
const NAMES = [
  "Cold Open", "Signal Lost", "Paper Trail", "Low Hum", "Eastbound",
  "The Quiet Room", "Salt & Iron", "First Light", "Hairline",
  "After the Storm", "Long Way Home", "Static", "Stowaway",
  "Black Box", "Last Call",
];

const tag = (seriesId: string, season: number, num: number) =>
  `${seriesId}-s${season}e${num}`;
